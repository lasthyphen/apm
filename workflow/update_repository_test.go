...
import (
	...
	mockdb "github.com/lasthyphen/apm/storage/mocks"
...
func TestUpdateRepositoryExecute(t *testing.T) {
  ...
  url: "https://github.com/lasthyphen/spacesvm/archive/refs/tags/v0.0.3.tar.gz"
  ...
  vms:
    - "spacesvm"
  config:
    # This the default subnet config as of dijetsnode v1.7.10
    # TODO remove this
